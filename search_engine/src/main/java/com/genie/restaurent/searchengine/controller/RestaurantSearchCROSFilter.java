...
public class RestaurantSearchCROSFilter implements Filter {

	Logger logger = LoggerFactory.getLogger(RestaurantSearchCROSFilter.class);
	
	public RestaurantSearchCROSFilter() {
		logger.debug("RestaurantSearchCROSFilter constructor");
	}
